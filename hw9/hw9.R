...
optionlist <- list(hAxis="{title: 'displacement'}", vAxis="{title: 'miles per gallon'}", title="Miles per Gallon v.s. Displacement", height = "1000px")
...
Motion <- gvisMotionChart(WorldDat, idvar = "country", yvar = "life.expectancy", 
                          xvar = "fertility.rate", timevar = "year",
